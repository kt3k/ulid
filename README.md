...
```js
import { ulid } from "https://deno.land/x/ulid@v0.1.0/mod.ts";
```
...
```js
import { monotonicFactory } from "https://deno.land/x/ulid@v0.1.0/mod.ts";
...
```js
import { factory } from "https://deno.land/x/ulid@v0.1.0/mod.ts";
